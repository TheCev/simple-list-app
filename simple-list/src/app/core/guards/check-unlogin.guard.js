...
exports.CheckUnLoginGuard = void 0;
var core_1 = require("@angular/core");
var operators_1 = require("rxjs/operators");
var auth_service_1 = require("src/app/shared/services/auth.service");
var router_1 = require("@angular/router");
var CheckUnLoginGuard = /** @class */ (function () {
    function CheckUnLoginGuard(authSvc, router) {
        this.authSvc = authSvc;
        this.router = router;
    }
    CheckUnLoginGuard.prototype.canActivate = function () {
        var _this = this;
    ...
    return CheckUnLoginGuard;
}());
exports.CheckUnLoginGuard = CheckUnLoginGuard;

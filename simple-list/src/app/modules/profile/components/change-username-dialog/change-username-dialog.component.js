...
exports.ChangeUsernameDialogComponent = void 0;
//Angular
...
var ChangeUsernameDialogComponent = /** @class */ (function () {
    //Dependencies injection
    function ChangeUsernameDialogComponent(dialogRef) {
        var _this = this;
        this.dialogRef = dialogRef;
        //Properties
        //title input, with validators
        this.usernameInput = new forms_1.FormControl('', [forms_1.Validators.required, forms_1.Validators.maxLength(30), forms_1.Validators.minLength(6)]);
        //if the cancel button is pressed
        this.onNoClick = function () { return _this.dialogRef.close(); };
    }
    //Methods
    //verify if have more than 40 characters, then show an error
    ChangeUsernameDialogComponent.prototype.checkMaxLength = function () {
        return this.usernameInput.hasError('maxlength') && this.usernameInput.dirty;
    };
    ChangeUsernameDialogComponent = __decorate([
        core_1.Component({
    ...
    return ChangeUsernameDialogComponent;
}());
exports.ChangeUsernameDialogComponent = ChangeUsernameDialogComponent;
